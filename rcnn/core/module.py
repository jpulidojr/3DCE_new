...
class MutableModule(BaseModule):
    ...
    def fit(self, train_data,ogdb, eval_data=None, eval_metric='acc',
        ...
        cur_val=0
        target_prec=30 #TODO: Hook criteria with yml
        ...
        for epoch in range(begin_epoch, num_epoch):
            ...
            if redo_training:
                ...
                if len(val_list) > 2: #TODO: Hook criteria with yml
                ...
                if iterdiff < 0.01: #TODO: Hook criteria with yml
                    ...
                    # OR, Try to read in another random subset
                    #sroidb = sample_roidb(ogdb, 25) # Sample with removal. TODO: Hook criteria with yml
                else:
                    # Continue as usual
                    # Select a new random subset before append
                    newroidb = sample_roidb(ogdb, 10) # Without removal, this is 10% TODO: Hook criteria with yml
                ...
                target_prec=target_prec+5 #TODO: Hook with yml
            end_of_batch = False
